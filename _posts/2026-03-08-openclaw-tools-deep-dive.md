...
slug: 2026-03-08-openclaw-tools-deep-dive
summary: 贺哥媳妇用 OpenClaw 联网搜索时报错 `brave key not configured`，由此引出对 OpenClaw 原生 Tools 的全面深度解析--5 大联网搜索供应商怎么申请、怎么配 Key、怎么重启生效，以及 browser、pdf、subagents 这几个强力工具的真实能力边界。
date: 2026-03-08
tags:
  - OpenClaw
  - AI工具
